        ...
        <el-row>
          ...
          <el-form-item label="维修人员" class="mr-3" label-width="70px" prop="fixPeople">
            <el-select
              filterable
              multiple
              v-model="form.fixPeople"
              style="width:140px; margin-right:15px;"
            >
              <el-option
                v-for="(item,index) in fixPeopleList"
                :key="index"
                :label="item.name"
                :value="item.name"
              ></el-option>
          ...
          <div v-for="(item,index) in form.data" :key="index">
            ...
            <el-form-item label="配件数量" class="mr-3" label-width="70px" prop="accessoriesShuLiang">
              <el-input
                style="width:140px; margin-right:15px;"
                autocomplete="off"
                v-model.number="item.accessoriesShuLiang"
                @blur="peijianSum(item,index)"
              ></el-input>
            </el-form-item>
        ...
        <el-row>
          <el-form-item label="配件合计" class="mr-3" label-width="70px" prop="accessoriesSum">
            <el-input
              style="width:140px; margin-right:15px;"
              autocomplete="off"
              v-model.number="form.accessoriesSum"
            ></el-input>
          </el-form-item>
          <el-form-item label="人工费" class="mr-3" label-width="70px" prop="artificial">
            <el-input
              style="width:140px; margin-right:15px;"
              autocomplete="off"
              v-model.number="form.artificial"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="人均人工" class="mr-3" label-width="70px" prop="averagePrice">
            <el-input
              style="width:140px; margin-right:15px;"
              autocomplete="off"
              v-model.number="form.averagePrice"
            ></el-input>
          </el-form-item>
